...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Damaged Christian Ministry" },
      { name: "theme-color", content: "#0f0d0c" },
      {
        name: "description",
        content:
          "Damaged Christian Ministry — teachings, podcast, and books for wounded disciples.",
      },
    ],
    links: [
...
function RootDocument() {
  return (
    <html lang="en" data-site="damaged" className="antialiased" suppressHydrationWarning>
      <head>
        <HeadContent />
      </head>
